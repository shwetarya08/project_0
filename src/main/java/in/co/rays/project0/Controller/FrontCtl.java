 ...
 * logged-in then forward control to login page.  Authorization means role based access. 
 * User of different roles will have different kind of access in the application. 
 * 
